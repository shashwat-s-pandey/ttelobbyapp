...
const Sidebar = ({ onLogin, isOpen }: { onLogin: () => void; isOpen: boolean }) => {
  ...
  return (
    <div>
      ...
      <aside
  className={`absolute left-0 top-[125px] w-[187px] transition-all duration-300 shadow-xl border-gray-200 bg-white/80 backdrop-blur-lg flex flex-col min-h-[calc(100vh+260px)] md:min-h-[calc(100vh-130px)] lg:min-h-[calc(100vh-130px)] bottom-0 z-40 ${
